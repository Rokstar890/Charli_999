...
PICS = (environ.get('PICS', 'https://graph.org/file/2305de75195eafa25376c.jpg')).split()
NOR_IMG = environ.get("NOR_IMG", "https://te.legra.ph/file/a27dc8fe434e6b846b0f8.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://te.legra.ph/file/6f55d902f9bf2d0afd4bb.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5689386887').split()]
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/CinemaV00/299')#not added
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002133531200'))
BF_LOG = int(environ.get('BF_LOG', '0'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/RkBackup1')
